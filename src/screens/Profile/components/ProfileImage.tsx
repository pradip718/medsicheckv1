    ...
    <View style={styles.container}>
      ...
      <View className="flex-row mt-2">
        <RoundedButton
          resetStyle
          style={{
            backgroundColor: customColor.cornflowerBlue,
          }}
          className="bg-cornflowerBlue px-4 py-2"
          onPress={handleProfileImage}>
          <CustomText className="text-sm text-black font-isidoraMedium">
            {languages?.change_photo}
          </CustomText>
        </RoundedButton>
        <RoundedButton
          resetStyle
          ...
          className="bg-cornflowerBlue px-4 py-1 ml-4"
          onPress={navigateToUserInformation}>
          <CustomText className="text-sm text-black font-isidoraMedium">
            {languages?.edit_details}
          </CustomText>
        </RoundedButton>
      </View>
    </View>
