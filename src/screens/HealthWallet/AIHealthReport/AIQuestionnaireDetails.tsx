...
type AIQuestionnaireDetailRouteProp = RouteProp<
  MainStackParamList,
  'AIQuestionnaireDetails'
>;

interface AIQuestionnaireDetailProps {
  route: AIQuestionnaireDetailRouteProp;
}
...
const AIQuestionnaireDetails = ({route}: AIQuestionnaireDetailProps) => {
...
export default AIQuestionnaireDetails;
