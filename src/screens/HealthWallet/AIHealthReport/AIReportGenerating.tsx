  ...
  return (
    <ImageBackground
      ...
      <View className="items-center justify-center flex-1">
        <Image
          source={require('../../../../assets/images/ai_report_generating.png')}
          className="w-full h-96"
          resizeMode="contain"
        />
        <View className="gap-4">
          <Text style={styles.title}>
            {languages?.generating_personalised_title}
          </Text>
          <Text style={styles.info}>
            {languages?.generating_personalised_info}
          </Text>
        </View>
      </View>
