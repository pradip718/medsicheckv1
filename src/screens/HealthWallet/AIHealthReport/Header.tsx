...
import {AIHealthReportDetailResponse} from '../../../../types/api_response';
...
type HeaderProps = {
  aiReportDetails: AIHealthReportDetailResponse[];
  created_at: string;
};

const Header = ({created_at, aiReportDetails}: HeaderProps) => {
