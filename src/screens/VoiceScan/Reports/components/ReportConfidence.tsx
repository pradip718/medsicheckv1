...
interface VoiceScanReportConfidenceProps {
...
export default function VoiceScanReportConfidence(
  props: VoiceScanReportConfidenceProps,
) {
  const {languages} = useLanguageStore();
  const [isSubConfidenceVisible, setIsSubConfidenceVisible] =
    useState<boolean>(false);
  const {overallConfidence, readingsConfidence} = props;
