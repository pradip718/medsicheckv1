...
import RenderTImeFormat from './components/RenderTImeFormat';
...
const Answer = ({
  ...
  switch (details?.question_type) {
    ...
    case QuestionType.TimeFormat:
    case QuestionType.DateFormat:
    case QuestionType.DateTimeFormat:
      return (
        <RenderTImeFormat
          handleSelectedAnswers={handleSelectedAnswers}
          selectedAnswers={selectedAnswers}
          type={details?.question_type as 'date' | 'time' | 'datetime'}
          validations={(details?.validation as TimeValidation) || {}}
        />
      );
