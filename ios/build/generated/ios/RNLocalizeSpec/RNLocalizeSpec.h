...
// Avoid multiple includes of RNLocalizeSpec symbols
#ifndef RNLocalizeSpec_H
#define RNLocalizeSpec_H
...
- (void)openAppLanguageSettings:(RCTPromiseResolveBlock)resolve
                         reject:(RCTPromiseRejectBlock)reject;

@end

@interface NativeRNLocalizeSpecBase : NSObject {
@protected
