...
// Avoid multiple includes of RNSentrySpec symbols
#ifndef RNSentrySpec_H
#define RNSentrySpec_H
...
- (void)initNativeReactNavigationNewFrameTracking:(RCTPromiseResolveBlock)resolve
                                           reject:(RCTPromiseRejectBlock)reject;
- (void)captureReplay:(BOOL)isHardCrash
              resolve:(RCTPromiseResolveBlock)resolve
               reject:(RCTPromiseRejectBlock)reject;
...
inline bool JS::NativeRNSentry::SpecCaptureEnvelopeOptions::hardCrashed() const
{
